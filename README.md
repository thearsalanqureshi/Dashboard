# Dashboard
A educational administration dashboard prototype featuring three core screens: Dashboard (analytics), Courses (content management), and Profile (settings). The prototype demonstrates a clean, data-rich interface for educators or administrators to monitor course progress, student engagement, and platform metrics.
